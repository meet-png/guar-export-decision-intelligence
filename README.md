...
> ⚙️ **v2 — "Guar Export Decision Intelligence" (product fork).** This repository is a product-direction fork of **JEIS v1** (a portfolio analytics project, kept frozen as the original artifact). v2 is being moulded into a focused, paid-pilot product for guar-gum exporters answering two money decisions — **WHEN to sell** (price-timing) and **WHERE to sell** (market-pivot radar). This README still reflects v1 and will be reframed around the product as it takes shape.
